...
Route::middleware('throttle:5,1')->group(function () {
    ...
    // Register is DISABLED — invite-only access
    ...
    // Invitation accept (public — token-based)
    Route::get('/invitations/{token}/validate', [InvitationController::class, 'validate_token']);
...
Route::middleware(['auth:sanctum', 'throttle:api', 'cors.tpt'])->prefix('v1')->group(function () {
    ...
    Route::prefix('training')->group(function () {
        Route::middleware('permission:hr.view')->group(function () {
            Route::get('programs', [TrainingController::class, 'lisograms']);
    ...
    Route::prefix('invitations')->middleware('role:admin')->group(function () {
