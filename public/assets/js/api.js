...
class APIClient {
    ...
    async request(method, endpoint, data = null, options = {}) {
        ...
        const requesomise = this._makeRequest(method, url, data, options, cacheKey);
        this.pendingRequests.set(cacheKey, requesomise);

        try {
            const result = await requesomise;
