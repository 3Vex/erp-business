...
class ApiClient {
    ...
    async request(method, endpoint, data = null, options = {}) {
        ...
        // Make the request
        const requesomise = this.makeHtequest(finalUrl, processedConfig);

        // Store in request queue
        this.requestQueue.set(cacheKey, requesomise);

        try {
            const response = await requesomise;
