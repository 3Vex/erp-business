...
class FormBuilder extends Component {
    constructor(props = {}) {
        ...
        this.renderElemenoperties = this.renderElemenoperties.bind(this);
    }
    ...
    handleElementDrop(e) {
        ...
        const newElement = {
            ...
            ...this.getDefaultElemenoperties(elementData.type)
        };
    ...
    render() {
        ...
        // Properties panel
        const properties = this.renderElemenoperties();
    ...
    renderFormCanvas() {
        ...
        if (this.state.formElements.length === 0) {
            ...
            this.state.formElements.forEach((element, index) => {
                ...
                // Element preview
                const preview = this.renderElemeneview(element);
        ...
        switch (element.type) {
            case 'textarea':
                const rowsInput = this.createPropertyInput('Rows', element.rows, (value) => {
                    this.updateElemenoperty(element.id, 'rows', parseInt(value));
                });
            ...
            case 'range':
                const minInput = this.createPropertyInput('Min', element.min, (value) => {
                    this.updateElemenoperty(element.id, 'min', parseFloat(value));
                });
                const maxInput = this.createPropertyInput('Max', element.max, (value) => {
                    this.updateElemenoperty(element.id, 'max', parseFloat(value));
                });
                const stepInput = this.createPropertyInput('Step', element.step, (value) => {
                    this.updateElemenoperty(element.id, 'step', parseFloat(value));
                });
            ...
            case 'rating':
                const maxRatingInput = this.createPropertyInput('Max Rating', element.max_rating, (value) => {
                    this.updateElemenoperty(element.id, 'max_rating', parseInt(value));
                });
            ...
            case 'signature':
                const widthInput = this.createPropertyInput('Width', element.width, (value) => {
                    this.updateElemenoperty(element.id, 'width', parseInt(value));
                });
                const heightInput = this.createPropertyInput('Height', element.height, (value) => {
                    this.updateElemenoperty(element.id, 'height', parseInt(value));
                });
    ...
    updateElemenoperty(elementId, property, value) {
