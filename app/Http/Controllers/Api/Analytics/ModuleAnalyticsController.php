...
class ModuleAnalyticsController extends BaseApiController
{
    public function finance(Request $request): JsonResponse
    {
        ...
        $cashFlowTrend = DB::table('finance_transactions')
            ...
            ->selectRaw(
                $this->dateFormatSql('finance_transactions.transaction_date') . " as month,
    ...
    public function inventory(Request $request): JsonResponse
    {
        ...
        $stockMovementHistory = DB::table('inventory_stock_movements')
            ...
            ->selectRaw(
                $this->dateFormatSql('inventory_stock_movements.movement_date') . " as month,
                 type,
                 COUNT(*) as count,
    ...
    public function sales(Request $request): JsonResponse
    {
        ...
        $revenueByMonth = DB::table('sales_orders')
            ...
            ->selectRaw(
                $this->dateFormatSql('created_at') . " as month,
