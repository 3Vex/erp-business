...
class InventorySeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($categories as $cat) {
            ...
            $categoryIds[$cat['name']] = DB::table('inventory_categories')->where('slug', $slug)->value('id');
        }
        ...
        foreach ($warehouses as $wh) {
            ...
            $warehouseIds[$wh['code']] = DB::table('inventory_warehouses')->where('code', $wh['code'])->value('id');
        }
