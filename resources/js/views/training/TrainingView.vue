                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <tr v-for="s in sessions" :key="s.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-3 text-right">
                                ...
                                <button @click="openEnrollModal(s)" class="text-xs text-purple-600 hover:text-purple-800">Enroll</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
function openEnrollModal(s: any) { enrollingSession.value = s; enrollForm.employee_id = 0; showEnrollModal.value = true; }
